"""trend_leash.py -- how long to hold, and how much it hurts on the way.
...
OUT = os.path.join("validation", "trend_leash.json")
BARS_DAY_TF = 24

TAKES = [("no partial", None, 0.0), ("a third at 2R", "2R", 1 / 3)]
RUNS = ["higher low", "clear break", "trail 3 bars under the high", "trail 5 bars under the high",
        "hold 7 days", "hold 14 days", "hold 30 days", "hold 60 days"]
HOLD_DAYS = {"hold 7 days": 7, "hold 14 days": 14, "hold 30 days": 30, "hold 60 days": 60}
TRAIL = {"trail 3 bars under the high": 3.0, "trail 5 bars under the high": 5.0}
