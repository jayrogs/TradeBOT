...
jobs = [["studies/trend_ride.py", "--exits2", "--procs", "20", "--log", "logs/trend_ride_exits2.log"],
        ["studies/trend_ride.py", "--exits2", "--focus", "--procs", "20", "--log", "logs/trend_ride_exits2_focus.log"]]
with open("logs/rerun_exits2.log", "a") as f:
    for j in jobs:
